...
public class RoleController extends BaseController<Role, Long> {
    ...
    public Result<Map<String, Object>> getByCondition(@ModelAttribute Role role,
                                                      @ModelAttribute SearchVo searchVo,
                                                      @ModelAttribute PageVo pageVo) {

        Page<Role> page = roleService.findByCondition(role, searchVo, PageUtil.initPage(pageVo));
