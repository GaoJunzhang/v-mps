...
public class DeviceController {
    ...
    public Result<Page<DeviceBean>> getVaildDevicePage(@ModelAttribute PageVo pageVo, String deviceName,String deviceMac) {

        Page<DeviceBean> page = iDeviceService.getVaildDevicePage(pageVo.getPageNo(), pageVo.getPageSize(), deviceName,deviceMac);
        return new ResultUtil<Page<DeviceBean>>().setData(page);
    }
