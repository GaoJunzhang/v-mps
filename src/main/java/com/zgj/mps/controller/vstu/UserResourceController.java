...
public class UserResourceController {
    ...
    @ApiOperation(value = "分页获取")
    public Result<Page<UserAuthBean>> userAuthData(@ModelAttribute PageVo pageVo,
                                                   @ModelAttribute SearchVo searchVo,
                                                   String nickName, Short isForever) {

        Page<UserAuthBean> userAuthBeanPage = iUserResourceService.userAuthData(pageVo, searchVo, nickName, isForever);
        return new ResultUtil<Page<UserAuthBean>>().setData(userAuthBeanPage);
    }
